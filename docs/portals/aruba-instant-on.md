...
In RADIUS profile create a new RADIUS profile and add the details of your RADIUS server, such as IP address and shared secret (will be provided by Splash Networks' team). **Require RADIUS Message-Authenticator** should be unchecked:

![Aruba Portal URL](../assets/images/portals/aruba/radius.png)

...
**Note**: You need to enter SMTP parameters for email verification, and API credentials of your SMS provider - such as Twilio - for SMS verification, in [Global Settings](global-settings.md).
